...
下面两张原稿截图展示了字符串常量合并和只读存储区的典型现象。具体地址会随编译器、链接器和每次运行而变化，不应把图中的地址当成固定值。

![字符串常量合并示例](https://s2.loli.net/2025/11/08/Hvo9GiUOm6MeTrj.png)

![字符串常量只读区域示例](https://s2.loli.net/2025/11/08/8rIk2otA1JLKYV7.png)
