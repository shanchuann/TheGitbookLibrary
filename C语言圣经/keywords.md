...
关键字总表适合快速检索，分类图则更适合建立整体印象。图中的分类沿用原稿，具体含义以本章后面的逐项说明和当前标准版本为准。

![关键字分类图 1](https://i-blog.csdnimg.cn/blog_migrate/38adf54569244ef2a1946d5c5fa1c1ae.png)

![关键字分类图 2](https://i-blog.csdnimg.cn/blog_migrate/9dd15044b62e83979e4ed1aeba19e066.png)
